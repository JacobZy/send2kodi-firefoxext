...
function saveOptions(e) {
	...
	proxyprocol: document.querySelector("#proxyprocol").value,
	proxyadd: document.querySelector("#proxyadd").value,
	proxyport: document.querySelector("#proxyport").value
    });
...
function restoreOptions() {
	...
	document.querySelector("#proxyprocol").value = result.proxyprocol || '';
	document.querySelector("#proxyadd").value = result.proxyadd || '';
	document.querySelector("#proxyport").value = result.proxyport || '';
    });
}
